...
namespace SampleClassification.ConsoleApp
{
    public partial class SampleClassification
    {
        ...
        private static string MLNetModelPath = Path.GetFullPath("mlstuff\\SampleClassification.mlnet");
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("Outcome");
            if (labelColumn == null)
            {
                throw new Exception("Outcome column not found. Make sure the name searched for matches the name in the schema.");
            }
